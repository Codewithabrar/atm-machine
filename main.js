...
if (pinAnswer.pinQuestion === myPin) {
    ...
    if (operationAnswer.operation === "fastCash") {
        ...
        if (fastCash.exactAmount >= myAmount) {
            console.log(`${chalk.greenBright.bold("low balance you can not withdraw")}`);
        }
    ...
    if (operationAnswer.operation === "withdraw") {
        ...
        if (amountAnswer.amount % 500 === 0 && amountAnswer.amount <= 25000) {
            ...
            console.log(`${chalk.bgGreenBright.bold("sorry we can not proceed your tansetion please enter a valid amount")}`);
        }
